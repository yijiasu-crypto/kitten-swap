...
export interface UniswapExchangeAdapter extends BaseContract {
  constructor(
    jsonInterface: any[],
    address?: string,
    options?: ContractOptions
  ): UniswapExchangeAdapter;
  clone(): UniswapExchangeAdapter;
  methods: {
    adapterName(): NonPayableTransactionObject<string>;

    uniswapRouter(): NonPayableTransactionObject<string>;
